...
# Configure page
st.set_page_config(
    page_title="AIForce Development Responsible AI Risk Assessment",
    page_icon="🤖",
    layout="wide",
...
ASSESSMENT_DATA = {
    ...
    "Operational Process Controls": {
        ...
        "questions": [
            ...
            {
                "text": "How do you monitor and respond to incidents involving AI model failures or unexpected behaviors in your development pipeline?",
                "options": [
...
def create_classification_levels_chart(responses):
    ...
    categories = ["Governance", "Technical", "Operational", "Transparency"]
...
def display_header():
    ...
    <div class="header-container">
        ...
        <div class="hcl-subtitle">AIForce Development Responsible AI Risk Assessment</div>
