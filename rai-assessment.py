...
ASSESSMENT_DATA = {
    "Fairness Controls": {
        "description": "Measures to ensure AI systems operate fairly across different groups and demographics, preventing bias and discrimination in AI-assisted development processes.",
        "tenet": "Fairness",
        "hover_description": "Ensures AI systems treat all users and groups equitably, preventing discriminatory outcomes in development processes.",
        "questions": [
            {
    ...
    "Privacy Controls": {
        "description": "Safeguards and protocols that protect personally identifiable information and sensitive data when using AI systems in development processes, ensuring compliance with privacy regulations.",
        "tenet": "Privacy",
        "hover_description": "Protects personal data and sensitive information through comprehensive privacy controls and secure AI implementation practices.",
        "questions": [
            {
...
def display_results():
    ...
    with col1:
        st.markdown("""
        <div class="risk-card">
            <h3 style="color: white; margin-bottom: 1rem;">📊 Responsible AI Pillars</h3>
        </div>
        """, unsafe_allow_html=True)
